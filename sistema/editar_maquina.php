		...
		if (empty($_POST['nombre']) || empty($_POST['correo']) || empty($_POST['usuario']) || empty($_POST['rol'])) 
		{
			...
			if ($result>0){
				...
				if($sql_update){
					...
					$alert='<p class="msg_error">Error al actualizar la máquina</p>';
				}
			}
		}
	}
	...
	<section id="container">
		...
		<div class="form_register">
			...
			<form action="" method="post">
				...
				<label for="rol">Tipo de máquina</label>
				...
				<br>
				<input type="submit" value="Actualizar Máquina" class="btn_save">
				<br>
