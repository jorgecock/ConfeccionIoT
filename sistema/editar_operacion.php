		...
		if (empty($_POST['nombre']) || empty($_POST['correo']) || empty($_POST['usuario']) || empty($_POST['rol'])) 
		{
			...
			if ($result>0){
				...
				if($sql_update){
					...
					$alert='<p class="msg_error">Error al actualizar la operación</p>';
				}
			}
		}
	}
...
<head>
	...
	<title>Actualizar Operaciones</title>
</head>
	...
	<section id="container">
		...
		<div class="form_register">
			...
			<form action="" method="post">
				...
				<label for="rol">Tipo de Operación</label>
				...
				<br>
				<input type="submit" value="Actualizar Operación" class="btn_save">
				<br>
				<a class="btn_cancel" href="lista_operaciones.php">Cancelar</a>
			</form>
		</div>
	</section>
